...
- Address valid CodeRabbitAI findings, or document the rationale for not addressing them, then re-run the relevant checks and request/wait for a follow-up review when code changed.
